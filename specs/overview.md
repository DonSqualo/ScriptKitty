...
**Core tenets:**
- stdlib contains only essential primitives and pipeline: `box`, `cylinder`, `union`, `difference`, `group`, `assembly`, `component`, `view`, `export_stl` (3MF API exists but backend not implemented)
